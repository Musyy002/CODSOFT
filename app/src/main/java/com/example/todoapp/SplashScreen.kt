...
class SplashScreen : AppCompatActivity() {
    ...
    private val textToType = "To-Do App"
    ...
    private fun checkUserStatus() {
        ...
        if (isFirstTime) {
            ...
            // Open InfoActivity
            startActivity(Intent(this@SplashScreen, InfoActivity::class.java))
        } else {
            // Existing user, open MainActivity
            startActivity(Intent(this@SplashScreen, MainUserInterface::class.java))
        }
